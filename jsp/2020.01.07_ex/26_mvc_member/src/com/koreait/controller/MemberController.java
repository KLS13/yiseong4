...
import com.koreait.model.BuyAction;
import com.koreait.model.ChangePwAction;
import com.koreait.model.GoBuyPage;
import com.koreait.model.GoChangePwAction;
import com.koreait.model.GoIndexPage;
import com.koreait.model.GoJoinPage;
import com.koreait.model.GoLeavePage;
...
import com.koreait.model.ItemManageAction;
import com.koreait.model.JoinAction;
import com.koreait.model.LeaveAction;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 단순 이동
				...
				case "/changePwPage.do":
					...
					break;
				case "/joinPage.do" :
					action = new GoJoinPage();
					break;
				case "/leavePage.do" :
					action = new GoLeavePage();
					break;
				case "/buyPage.do" :
					action = new GoBuyPage();
					break;
				// DB 사용
				case "/login.do":
