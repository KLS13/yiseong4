		...
		<form action="modify" method="post">
			...
			<table>
				<tbody>
					...
					<tr>
						<td>전화번호</td>
						<td><input type="text" name="bTel" value="${bDto.bTel}"/></td>
					</tr>
					<tr>
						<td>주소</td>
						<td><input type="text" name="bAddr" value="${bDto.bAddr}"/></td>
					</tr>
					<tr>
						<td>이메일</td>
						<td><input type="text" name="bEmail" value="${bDto.bEmail}"/></td>
					</tr>
					<tr>
						<td>내용</td>
						<td>
							<textarea rows="10" cols="50" name="bNote">
								${bDto.bNote}
							</textarea>	
						</td>
					</tr>
