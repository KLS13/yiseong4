...
public class PurchaseDto {
	...
	public PurchaseDto(int pIdx, int gIdx, int pQuantity, Date pDate, String uId_, String pReceiver, String pPhone,
			String pAddress, String pAddressDetail, String pMessage, String pInvoiceNo) {
		super();
		this.pIdx = pIdx;
		this.gIdx = gIdx;
